...
\begin{titlepage}
    ...
    \begin{tcolorbox}[
        ...
        \texttt{\large https://github.com/YasserHamdan/NLP-NER-Project}\\[1em]
        \normalsize (Yasser will send you the actual link)
    \end{tcolorbox}
...
\begin{commandbox}
\texttt{\textcolor{terminalgreen}{>} git clone https://github.com/USERNAME/NLP-NER-Project.git}\\
\texttt{\textcolor{terminalgreen}{>} cd NLP-NER-Project}
\end{commandbox}

\textit{Replace the URL with the actual GitHub link Yasser sends you.}
